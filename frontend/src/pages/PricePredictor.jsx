      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <form onSubmit={handlePredict} className="space-y-5">
              ...
              <div>
                ...
                <input 
                  type="text" 
                  name="breed" 
                  placeholder="e.g. Red Chittagong, Sahiwal" 
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-green-700 text-white py-3 rounded-lg font-bold text-lg hover:bg-green-800 transition shadow-md disabled:bg-gray-400"
              >
          ...
          <div className="flex flex-col justify-center">
            {prediction !== null ? (
              <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-green-500 text-center animate-pulse-once">
                ...
                <p className="text-xs text-gray-400 mt-4">
                  *This is an estimate based on historical data. Actual price may vary based on health and location.
                </p>
              </div>
            ) : (
              <div className="bg-blue-50 p-8 rounded-xl border border-blue-200 text-center opacity-80">
                 ...
                 <p className="text-blue-600 mt-2 text-sm leading-relaxed">
                   Enter the details of the animal on the left. Our trained AI model will analyze the breed, weight, and age to give you the most accurate market price prediction available.
                 </p>
              </div>
            )}
